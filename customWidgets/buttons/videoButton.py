...
class VideoButton(QPushButton):
    ...
    def enterEvent(self, event: QtCore.QEvent):
        super(VideoButton, self).enterEvent(event)
    ...
    def leaveEvent(self, event: QtCore.QEvent):
        super(VideoButton, self).leaveEvent(event)
        self.setMinimumSize(150, 50)
        self.setMaximumSize(150, 50)
        self.setGeometry(self.pos().x() + 10, self.pos().y(), self.width() - 10, self.height())
    ...
    def onClick(self):
        ...
        self.setText("Video On") if self.text() == "Video Off" else self.setText("Video Off")
